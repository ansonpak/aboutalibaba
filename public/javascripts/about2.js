...
Question.preload = function()
{
    ...
    this.load.image('aliyun', '/assets/阿里雲.jpg');
...
Question.create = function()
{
    ...
    var background = "cloud computing services :";
    var questionText = this.add.text(150, 150, background, textConfig);


    // cria botoes das respostas
    var aliyun = this.add.sprite(400, 350, 'aliyun');
    aliyun.setDisplaySize(400,180);
    var aliyunText = this.add.text(400, 450, 'Aliyun', textConfig1);
