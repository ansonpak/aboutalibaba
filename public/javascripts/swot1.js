...
Question.create = function()
{
    ...
    var background = "Weakness:";
    var questionText = this.add.text(150, 150, background, textConfig);
    var text1 = "Alibaba platform  have too many  fake products, which leads to customers not trusting.So the customers has low loyalty.And Alibaba source of the product information is mostly from other websites or newspapers so they is more difficult to collect first-hand business information.";
