...
Intro.create = function()
{
    ...
    resize();
    // cria titulo
    var title = this.add.text(400, 100, 'Alibaba', {
    ...
    // cria botao JOGAR
    var playButton1 = this.add.sprite(400, 200, 'nextButton');
    //playButton.setOrigin(0.5);
    var playLabel1 = this.add.text(400, 200, 'About Alibaba', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    playLabel1.setOrigin(0.5, 0.5);

    // cria botao JOGAR
    var playButton2 = this.add.sprite(400, 300, 'prevButton');
    //playButton.setOrigin(0.5);
    var playLabel2 = this.add.text(400, 300, 'Alibaba SWOT', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    playLabel2.setOrigin(0.5, 0.5);

    // cria botao JOGAR
    var playButton3 = this.add.sprite(400, 400, 'nextButton1');
    //playButton.setOrigin(0.5);
    var playLabel3 = this.add.text(400, 400, 'Game1', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    playLabel3.setOrigin(0.5, 0.5);

    // cria botao JOGAR
    var playButton = this.add.sprite(400, 500, 'prevButton1');
    //playButton.setOrigin(0.5);
    var playLabel = this.add.text(400, 500, 'Game2', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    ...
    playButton2.setInteractive({useHandCursor: true}).on('pointerdown', () => {
        location.href = "swot.ejs";
    });
    playButton3.setInteractive({useHandCursor: true}).on('pointerdown', () => {
        location.href = "matching.ejs";
    });
    playButton.setInteractive({useHandCursor: true}).on('pointerdown', () => {
        location.href = "quiz.ejs";
        resetGameState();
    });
}
...
Final.create = function()
{
    ...
    // cria titulo
    var title = this.add.text(400, 100, 'Game Over', {
        fontFamily: 'sans-serif',
        fontSize: '30px',
        color: '#ff9900'
    });
    ...
    // texto de pontuacao
    var scoreText = this.add.text(400, 300, 'Score: ' + Math.floor(score) + '%', {
        fontFamily: 'sans-serif',
        fontSize: '80px',
        color: '#000'
    });
    ...
    var restartLabel = this.add.text(400, 500, 'Retest', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
