...
Question.create = function()
{
    ...
    var background = "Opportunity:";
    var questionText = this.add.text(150, 150, background, textConfig);
    var text1 = "Alibaba is currently the world's leading small enterprise e-commerce company, which is conducive to the generation of enterprises and new technologies.Nowadays, the wireless network is developed, and you can enjoy shopping at anytime. Consumer demand is also increasing, and consumer are gradually getting used to online shopping. ";
