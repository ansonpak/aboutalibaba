...
Question.preload = function()
{
    ...
    this.load.image('swot', '/assets/swot.png');
...
//    var text1Text = this.add.text(150, 200, text1, textConfig);
    ...
    var swot = this.add.sprite(450, 450, 'swot');
    swot.setDisplaySize(700,597);
...
//    var alipayText = this.add.text(600, 450, 'alipay', textConfig1);
    ...
    var nextLabel = this.add.text(600, 650, 'Back Homepage', textConfig);
