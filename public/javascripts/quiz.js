...
Intro.create = function()
{
    ...
    resize();
    // cria titulo
    var title = this.add.text(400, 100, 'Alibaba Quiz', {
    ...
    // cria botao JOGAR
    var playButton1 = this.add.sprite(400, 450, 'prevButton');
    //playButton.setOrigin(0.5);
    var playLabel1 = this.add.text(400, 450, 'Home Page', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    ...
    //playButton.setOrigin(0.5);
    var playLabel = this.add.text(400, 500, 'Start', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
...
Final.create = function()
{
    ...
    var restartButton1 = this.add.sprite(400, 550, 'nextButton');
    var restartLabel1 = this.add.text(400, 550, 'Back Homepage', {
        fontFamily: 'sans-serif',
        fontSize: '24px',
        color: '#000'
    });
    restartLabel1.setOrigin(0.5, 0.5);
