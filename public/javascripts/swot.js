...
Question.create = function()
{
    ...
    var background = "Strength:";
    var questionText = this.add.text(150, 150, background, textConfig);
    var text1 = "Alibaba has adequate capital and strong operational ability to sell.Alibaba staff training is complete.It is the leader in the C2C and B2B markets,the most attractive aspect of Alibaba is that it charges a lower B2B agency fee, and the online store is free!";
